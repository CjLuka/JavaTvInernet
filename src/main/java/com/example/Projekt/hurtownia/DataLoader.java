...
public class DataLoader {
  ...
  private ZamowieniaRepo zamowieniaRepo;
	@Autowired
  public DataLoader(PackageRepo packageRepo,PackageProductRepo packageProductRepo, PersonRepo personRepo,PlatnosciRepo platnosciRepo,ProductRepo productRepo,ZamowieniaRepo zamowieniaRepo){
    this.packageRepo = packageRepo;
    this.packageProductRepo = packageProductRepo;
